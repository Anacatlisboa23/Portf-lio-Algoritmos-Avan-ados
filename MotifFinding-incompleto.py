...
class MotifFinding:
    ...
    def gibbs (self, iteration : int =100) -> list[int]: 
        """ Usa o algoritmo Gibbs sampling para procurar o melhor motif na sequencia de DNA. 

    Args:
        iteration (int): O nº de interações a ser feitas.

    Returns:
        list: A lista de posições iniciais para o melhor motif. 
        """
        ...
        startpos = [randint(0, self.seqSize(x)-self.motifSize)
        ...
        while time_last_improvement< iteration:
             ...
             for x in range(iteration):  
                ...
                probabilidades=perfil.probAllPositions(outraseq) 
                roul=self.roulette(probabilidades) + startpos [i]
